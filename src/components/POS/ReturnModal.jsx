  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden animate-in zoom-in duration-200">
        ...
        {/* Content */}
        <div className="p-6">
          <div className="mb-4 bg-amber-50 border border-amber-100 p-4 rounded-xl">
          ...
          <div className="space-y-4 max-h-[300px] overflow-y-auto pr-2 custom-scrollbar">
            {returnItems.map(item => (
              <div key={item.productId} className="flex items-center justify-between p-3 border border-gray-100 rounded-xl hover:bg-gray-50 transition-colors">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="w-20 text-right">
                    <p className="text-sm font-black text-gray-900">₹{(item.price * item.returnQty).toFixed(2)}</p>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="mt-6 border-t pt-4">
            <label className="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-2">Reason for Return</label>
            <textarea 
              value={reason}
        ...
        <div className="p-6 bg-gray-50 border-t flex items-center justify-between">
          ...
          <button 
            ...
            className="px-8 py-4 bg-gray-900 hover:bg-black disabled:bg-gray-300 text-white font-bold rounded-xl shadow-lg transition-all active:scale-[0.98]"
          >
